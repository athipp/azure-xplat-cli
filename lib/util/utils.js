...
var getUserAgent = exports.getUserAgent = function () {
  var userAgent = util.format('WindowsAzureXplatCLI/%s', moduleVersion);
...
exports.createAnalysisServicesManagementClient = function (subscription) {
    var analysisServicesManagement = require("azure-arm-analysisservices");
    /*var factoryMethod = analysisServicesManagement.AnalysisServicesManagementClient;*/
    return this.createAutoRestClient(analysisServicesManagement, subscription);
};
